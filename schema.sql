...
CREATE TABLE IF NOT EXISTS customers (
    ...
    phone VARCHAR(64),
    pic_name_2 VARCHAR(255) DEFAULT NULL,
    phone_2 VARCHAR(64) DEFAULT NULL,
    pic_name_3 VARCHAR(255) DEFAULT NULL,
    phone_3 VARCHAR(64) DEFAULT NULL,
    address TEXT,
    office_address TEXT DEFAULT NULL,
    shipping_lat VARCHAR(64) DEFAULT NULL,
    shipping_lng VARCHAR(64) DEFAULT NULL,
    default_courier_id VARCHAR(64) DEFAULT NULL,
    default_courier_name VARCHAR(100) DEFAULT NULL,
    default_shipping_cost DECIMAL(15,2) DEFAULT 0.00,
    default_shipping_type VARCHAR(20) DEFAULT 'FRANCO',

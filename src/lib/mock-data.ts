...
export const initialBatches: StockBatch[] = [
  ...
  {
    id: 'batch-smp-001',
    batch_number: 'SMP-LUZ-2026-01',
    product_id: 'prod-001',
    product_name: 'ACASIA',
    variant_sku: 'FO-ACA-001-SMP',
    pack_size_kg: 0.1,
    unit_count: 1,
    ...
    sample_notes: 'Formula baru konsentrat Acasia ekstra manis, top notes jasmine lebih segar',
    sample_status: 'UJI_COBA',
    created_at: '2026-01-10'
  },
  {
    id: 'batch-smp-002',
    batch_number: 'SMP-BEL-2026-05',
    product_id: 'prod-002',
    product_name: 'BOUGENVILLE',
    variant_sku: 'FO-BOU-002-SMP',
    pack_size_kg: 0.25,
    unit_count: 1,
    ...
    is_expired: false,
    is_sample: true,
    supplier_name: 'Bell Flavors & Fragrances (Germany)',
    sample_target: 'Permintaan Tester Khusus Pelanggan',
    sample_notes: 'Tester 250g untuk PT Parfumerie Indah Nusantara',
    sample_status: 'DISETUJUI_PO',
    created_at: '2026-02-01'
  },
  {
    id: 'batch-smp-003',
    batch_number: 'SMP-PAR-2026-99',
    product_id: 'prod-smp-001',
    product_name: 'ROSE OUD VELVET',
    variant_sku: 'FO-ROV-SMP',
    pack_size_kg: 0.5,
    unit_count: 1,
    ...
    is_expired: false,
    is_sample: true,
    supplier_name: 'Parfex (France)',
    sample_target: 'Evaluasi Aroma Suplier Baru',
    sample_notes: 'Formulasi oriental woody rose premium untuk hotel amenities luxury',
    sample_status: 'UJI_COBA',

    ...
    <div className="bg-[#f5f7fa] min-h-screen pb-20">
      ...
      <main className="max-w-screen-2xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm space-y-3.5">
          ...
          {/* Date Range Picker & Search Bar & Reset Toolbar */}
          <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 pt-2.5 border-t border-gray-100">
            ...
            <div className="flex-1 flex items-end gap-2">
              <div className="flex-1">
                <label className="block text-[11px] font-semibold text-slate-500 mb-1">Pencarian Aktivitas</label>
                <form onSubmit={handleSearch} className="relative w-full">
                  ...
                  <input
                    ...
                    placeholder="Cari aktivitas, no referensi (SO/PO/SJ/INV), aktor..."
                    className="w-full pl-9 pr-18 py-2 bg-slate-50 border border-gray-200 rounded-lg text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500 font-medium"
                  />
                  <button
                    type="submit"
                    className="absolute right-1.5 top-1.5 bg-blue-600 hover:bg-blue-700 text-white text-[11px] font-bold px-2.5 py-1 rounded-md transition-colors cursor-pointer"
                  >
                    Cari
                  </button>
                </form>
              ...
              {(searchQuery || startDate || endDate || activeCategory !== 'ALL') && (
                <button
                  type="button"
                  onClick={handleResetFilters}
                  className="px-3 py-2 text-xs font-semibold text-rose-600 hover:text-rose-700 bg-rose-50 hover:bg-rose-100 border border-rose-200 rounded-lg transition-all flex items-center gap-1 cursor-pointer shrink-0 shadow-2xs h-[34px]"
